...
<div id=flower_categories>
    <h4> Flowers Add to Categories</h4>
...
<?php if (isset($category_name) && isset($flowers)): ?>
    <form action="flowers.php" method="post">
        <h4>Select a flowers - Category Name: <?php echo htmlspecialchars($category_name); ?></h4>
        ...
        <?php foreach ($flowers as $flower): ?>
            <div>
                <input type="checkbox" 
                       ...
                       <?php echo $flower['is_checked'] ? 'checked' : ''; ?>>
                <label><?php echo htmlspecialchars($flower['flower_name']); ?></label>
                <img src="../../<?php echo htmlspecialchars($flower['dir_path']); ?>" alt="No image" width="100px" height="100px"/>
            </div>
        <?php endforeach; ?>

        <button type="submit" name="submit_flowers_categories">Insert</button>
    </form>
<?php endif; ?>
